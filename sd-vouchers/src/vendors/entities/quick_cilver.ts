 ...
 * */
export default class QuickCilver {
	client_id;
	client_secret;
	redirect_uri;
	authorization;
	...
	getQuickCilverAuthCode = async (referenceId:any,vendor_code:any) => {
		try {
	...
	getQuickCilverOAuthToken = async (code,referenceId,vendor_code) => {
		try {
	...
	getOrderStatus = async (reference_id:any, access_token:any,vendor_code:any) => {
		try {
	...
	getBalance = async (cardNumber: any,pin:any,access_token:any,) => {
		try {
